        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection("; Initial Catalog = PandaCart; Integrated Security = True");
            {
                ...
                if (fuImg02.HasFile)
                {
                    ...
                    SqlCommand cmd4 = new SqlCommand("insert into ProductImages(PID,Name,Extention) values(@PID,@Name,@Extention)", con);
                ...
                if (fuImg03.HasFile)
                {
                    ...
                    SqlCommand cmd5 = new SqlCommand("insert into ProductImages(PID,Name,Extention) values(@PID,@Name,@Extention)", con);
                ...
                if (fuImg04.HasFile)
                {
                    ...
                    SqlCommand cmd6 = new SqlCommand("insert into ProductImages(PID,Name,Extention) values(@PID,@Name,@Extention)", con);
                ...
                if (fuImg05.HasFile)
                {
                    ...
                    SqlCommand cmd7 = new SqlCommand("insert into ProductImages(PID,Name,Extention) values(@PID,@Name,@Extention)", con);
